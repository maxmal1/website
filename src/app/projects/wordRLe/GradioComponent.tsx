  ...
  return (
    <main className="pt-[20vh] flex flex-col">
      ...
      <div className=" pt-16 flex-1 flex flex-col items-center p-4">
        <div className="max-w-md mx-auto">
         ...
         <p className="text-lg leading-6 italic p-2">
          ...
          <p className="text-lg leading-6">
            ...
            five letter word in six attempts or fewer. The user takes turns at guessing valid 
            ...
            the right position, that is in the same index of the target word, are green. 
          ...
          <p className="text-lg leading-6">
          This poses an interesting problem-space for reinforcment learning, especially on the 
          ...
          <p className="text-lg leading-6">
            ...
            the model still struggled. It would often collapse to gussing a single letter, or
            a few random letters.
            </p>
            <p className="text-lg leading-6">
            The reward structure was relatively simple, positive reward for getting a green, 
            smaller positive reward for guessing a yellow, and a negative reward for guessing
          ...
          <p className="text-lg leading-6">
            I decided to move to an "offline" reinforcment learning approach. I created synthetic games
            based around a somewhat optimal playing of Wordle. The first guess was randomly selected from 
            ...
            to have a green letter in previously found positions, yellow letters need to be present (but not 
          ...
          <p className="text-lg leading-6">
            This created a a lot of possible data for the model to learn. Using causal attention and cross-entropy loss, 
        ...
        />
          <p className="text-lg leading-6">
            The model trained for a maximum of 1,000 epochs, with an early stopping criteria of 20 epochs of no loss improvement.
          ...
          <p className="text-lg leading-6">
            ...
            a decoding method used by LLMs to attempt to find the most optimal sequence of tokens. Unlike the greedy approach, which
            selects the highest probability token each time, the beam search keeps a number of sequences (or beams) and keeps track of
            the cumulative log probability of the sequence, pruning out less probable sequences.
          </p>
          <p className="text-lg leading-6">
            With a beam search width of 4, the model can solve 90% of games. As a final improvement, and as a way to make a model play
            more like a human, I added a random value for the beam width at each word generation, which brought the number of games solved
            to 95%, though I expect the true number is higher, though the model might not win the game each time, it is capable of winning
            the majority of the time.
          </p>
          <p className="text-lg leading-6">
            In the future, I'd like to using PPO for reinforcment learning learning as a baseline. Right now, the model does a lot of things
            ...
            one of the most frequent starting words is "salep", which is very close to one of the optimal starting words of "salet", which was
