      ...
      <div className="mt-20 w-full max-w-4xl space-y-6">
        <div className="p-6 border-2 border-gray-500">
          ...
          <div className="text-sm ">
            <p className="mb-1">
              <span className="font-medium ">Email:</span> <a href="mailto:mimmalamut@gmail.com" className="text-[#B5FCFC] hover:underline">mimmalamut@gmail.com</a>
            </p>
            <p className="mb-1">
              <span className="font-medium ">LinkedIn:</span> <a href="https://www.linkedin.com/in/maxwellmalamut" target="_blank" rel="noopener noreferrer" className="text-[#B5FCFC] hover:underline">linkedin.com/in/maxwellmalamut</a>
            </p>
            <p className="mb-1">
              <span className="font-medium ">GitHub:</span> <a href="https://github.com/maxmal1" target="_blank" rel="noopener noreferrer" className="text-[#B5FCFC] hover:underline">github.com/maxmal1</a>
            </p>
          </div>
        </div>
        <div className="p-6 border-2 border-gray-500">
        ...
        <div className="p-6 border-2 border-gray-500">
          ...
          <div className="space-y-4">
            <div>
              <h3 className="text-lg font-medium ">Algorithms and AI Solutions Analyst</h3>
              <h3 className="text font-medium  ml-2">Toyon Research Corporation</h3>
              <p className="text-sm  mb-2 ml-4">June 2024 - Present</p>
            ...
            <div>
              <h3 className="text-lg font-medium ">Graduate Research Assistant</h3>
              <h3 className="text font-medium  ml-2">Computational Imaging Systems Lab @ Boston University</h3>
              <p className="text-sm  mb-2 ml-4">Sept 2023 - May 2024</p>
              <ul className="list-disc list-outside text-sm  space-y-1 ml-4">
            ...
            <div>
              ...
              <h3 className="text font-medium  ml-2">Red Hat Collaboratory @ Boston University</h3>
              <p className="text-sm  mb-2 ml-4">Jan 2023 - May 2023</p>
              <ul className="list-disc list-outside text-sm  space-y-1 ml-4">
            ...
            <div>
              <h3 className="text-lg font-medium ">Evaluation and Test Engineering Intern</h3>
              <h3 className="text font-medium  ml-2">GE Aerospace</h3>
              <p className="text-sm  mb-2 ml-4">May 2022 - Aug 2022</p>
              <ul className="list-disc list-outside text-sm  space-y-1 ml-4">
        ...
        <div className="p-6 border-2 border-gray-500">
          ...
          <div>
              <h3 className="text-lg font-medium ">Boston University</h3>
              <h3 className="text font-medium ">Master of Computer Engineering</h3>
              <p className="text-sm  mb-2">Sept 2023 - May 2024</p>
              <ul className="list-disc list-inside text-sm  space-y-1">
                <li>GPA: 3.95/4.00</li>
              </ul>
              <h3 className="text font-medium ">Bachelor of Mechanical Engineering</h3>
              <p className="text-sm  mb-2">Sept 2019 - May 2023</p>
              <ul className="list-disc list-inside text-sm  space-y-1">
                <li>GPA: 3.51/4.00</li>
              </ul>
            </div>
